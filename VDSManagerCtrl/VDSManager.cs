        ...
        public int ProcessTrafficDataEvent(TrafficDataEvent trafficDataEvent)
        {
            ...
            try
            {
                ...
                TRAFFIC_DATA trafficData = new TRAFFIC_DATA()
                {
                    ...
                    LENGTH = trafficDataEvent.length + VDSConfig.controllerConfig.LengthModifyValue,
                    SPEED = trafficDataEvent.speed + VDSConfig.controllerConfig.SpeedModifyValue,
                    VEHICLE_CLASS = trafficDataEvent.vehicle_class,
                    OCCUPY_TIME = trafficDataEvent.occupyTime + VDSConfig.controllerConfig.OccupyModifyValue,
                    ...
                    DETECT_DISTANCE =  Utility.GetModifyDistance(trafficDataEvent), // trafficDataEvent.detectDistance,
