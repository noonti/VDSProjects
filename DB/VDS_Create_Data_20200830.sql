...
DROP TABLE IF EXISTS `target_summary_info`;
...
) ENGINE=InnoDB AUTO_INCREMENT=1813218 DEFAULT CHARSET=utf8;

-- 내보낼 데이터가 선택되어 있지 않습니다.

-- 프로시저 vdsdb.SP_ADD_TARGET_SUMMARY_INFO 구조 내보내기
DROP PROCEDURE IF EXISTS `SP_ADD_TARGET_SUMMARY_INFO`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `SP_GET_ACCU_TRAFFIC_DATA_STAT`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `SP_GET_LENGTH_DATA_STAT`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `SP_GET_SPEED_DATA_STAT`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `SP_GET_TARGET_SUMMARY_BY_LANE_LIST`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `SP_GET_TARGET_SUMMARY_INFO_LIST`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `SP_GET_TARGET_SUMMARY_STAT`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `SP_GET_TRAFFIC_DATA_STAT`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `SP_UPDATE_TARGET_REPORT_YN`;
DELIMITER //
